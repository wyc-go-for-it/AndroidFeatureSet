...
public class Notificaitons {
    ...
    public final static String ACTION_SIMPLE = "com.android.wyc.notificationdemo.ACTION_SIMPLE";
    public final static String ACTION_ACTION = "com.android.wyc.notificationdemo.ACTION_ACTION";
    public final static String ACTION_REMOTE_INPUT = "com.android.wyc.notificationdemo.ACTION_REMOTE_INPUT";
    public final static String ACTION_BIG_PICTURE_STYLE = "com.android.wyc.notificationdemo.ACTION_BIG_PICTURE_STYLE";
    public final static String ACTION_BIG_TEXT_STYLE = "com.android.wyc.notificationdemo.ACTION_BIG_TEXT_STYLE";
    public final static String ACTION_INBOX_STYLE = "com.android.wyc.notificationdemo.ACTION_INBOX_STYLE";
    public final static String ACTION_MEDIA_STYLE = "com.android.wyc.notificationdemo.ACTION_MEDIA_STYLE";
    public final static String ACTION_MESSAGING_STYLE = "com.android.wyc.notificationdemo.ACTION_MESSAGING_STYLE";
    public final static String ACTION_PROGRESS = "com.android.wyc.notificationdemo.ACTION_PROGRESS";
    public final static String ACTION_CUSTOM_HEADS_UP_VIEW = "com.android.wyc.notificationdemo.ACTION_CUSTOM_HEADS_UP_VIEW";
    public final static String ACTION_CUSTOM_VIEW = "com.android.wyc.notificationdemo.ACTION_CUSTOM_VIEW";
    public final static String ACTION_CUSTOM_VIEW_OPTIONS_LOVE = "com.android.wyc.notificationdemo.ACTION_CUSTOM_VIEW_OPTIONS_LOVE";
    public final static String ACTION_CUSTOM_VIEW_OPTIONS_PRE = "com.android.wyc.notificationdemo.ACTION_CUSTOM_VIEW_OPTIONS_PRE";
    public final static String ACTION_CUSTOM_VIEW_OPTIONS_PLAY_OR_PAUSE = "com.android.wyc.notificationdemo.ACTION_CUSTOM_VIEW_OPTIONS_PLAY_OR_PAUSE";
    public final static String ACTION_CUSTOM_VIEW_OPTIONS_NEXT = "com.android.wyc.notificationdemo.ACTION_CUSTOM_VIEW_OPTIONS_NEXT";
    public final static String ACTION_CUSTOM_VIEW_OPTIONS_LYRICS = "com.android.wyc.notificationdemo.ACTION_CUSTOM_VIEW_OPTIONS_LYRICS";
    public final static String ACTION_CUSTOM_VIEW_OPTIONS_CANCEL = "com.android.wyc.notificationdemo.ACTION_CUSTOM_VIEW_OPTIONS_CANCEL";

    public final static String ACTION_YES = "com.android.wyc.notificationdemo.ACTION_YES";
    public final static String ACTION_NO = "com.android.wyc.notificationdemo.ACTION_NO";
    public final static String ACTION_DELETE = "com.android.wyc.notificationdemo.ACTION_DELETE";
    public final static String ACTION_REPLY = "com.android.wyc.notificationdemo.ACTION_REPLY";
    ...
    public void sendSimpleNotification(Context context,NotificationManager nm) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
            ...
            notification = new NotificationCompat.Builder(context,NotificationChannels.LOW)
                    //设置通知左侧的小图标
                    .setSmallIcon(R.mipmap.ic_notification)
                    //设置通知标题
                    .setContentTitle("Simple notification")
    ...
    public void sendActionNotification(Context context,NotificationManager nm) {
        ...
        NotificationCompat.Action yesActionBuilder = new NotificationCompat.Action.Builder(
                R.mipmap.ic_yes,
                "YES",
                yesPendingIntent)
                .build();
        ...
        NotificationCompat.Action noActionBuilder = new NotificationCompat.Action.Builder(
                R.mipmap.ic_no,
                "NO",
                noPendingIntent)
                .build();
        //为通知添加按钮
        nb.addAction(yesActionBuilder).addAction(noActionBuilder);
        //发送通知
    ...
    public void sendRemoteInputNotification(Context context,NotificationManager nm) {
        ...
        PendingIntent pi = PendingIntent.getService(context,0,intent,0);
        //创建通知
        NotificationCompat.Builder nb = new NotificationCompat.Builder(context,NotificationChannels.IMPORTANCE)
                //设置通知左侧的小图标
                .setSmallIcon(R.mipmap.ic_notification)
                //设置通知标题
    ...
    public void sendMediaStyleNotification(Context context, NotificationManager nm, boolean isPlaying) {
        ...
        Notification.Action nextAction = new Notification.Action.Builder(R.mipmap.ic_next,
                "Next",
                nextPendingIntent)
                .build();
        Intent deleteIntent = new Intent(context,NotificationService.class);
        ...
        Notification.Action deleteAction = new Notification.Action.Builder(R.mipmap.ic_delete,
                "Delete",
                deletePendingIntent)
                .build();
        ...
        //创建通知
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
            notification = new Notification.Builder(context,NotificationChannels.MEDIA)
                    //设置通知左侧的小图标
                    .setSmallIcon(R.mipmap.ic_notification)
                    //设置通知标题
            ...
            notification = new NotificationCompat.Builder(context,NotificationChannels.MEDIA)
                    //设置通知左侧的小图标
                    .setSmallIcon(R.mipmap.ic_notification)
                    //设置通知标题
                    .setContentTitle("Media style notification")
                    ...
                    .setContentIntent(pi)
                    //设置Action按钮
                    .addAction(isPlaying ? R.mipmap.ic_pause : R.mipmap.ic_play,
                            isPlaying ? "PAUSE" : "PLAY",
                            playOrPausePendingIntent)
                    .addAction(R.mipmap.ic_next,
                            "Next",
                            nextPendingIntent)
                    .addAction(R.mipmap.ic_delete,
                            "Delete",
        ...
        //发送通知
        nm.notify(NOTIFICATION_MEDIA_STYLE,notification);
    }
    ...
    public void sendMessagingStyleNotification(Context context, NotificationManager nm) {
        ...
        PendingIntent pi = PendingIntent.getService(context,0,intent,0);
        //创建信息样式
        NotificationCompat.MessagingStyle messagingStyle = new NotificationCompat.MessagingStyle("wyc")
                .setConversationTitle("Messaging style notification")
                .addMessage("This is a message for you", System.currentTimeMillis(),"wyc");
        //创建通知
        NotificationCompat.Builder nb = new NotificationCompat.Builder(context,NotificationChannels.DEFAULT)
                //设置通知左侧的小图标
                .setSmallIcon(R.mipmap.ic_notification)
    ...
    public void sendProgressViewNotification(Context context,NotificationManager nm, int progress) {
        ...
        PendingIntent pi = PendingIntent.getService(context,0,intent,0);
        //创建通知
        NotificationCompat.Builder nb = new NotificationCompat.Builder(context,NotificationChannels.LOW)
                //设置通知左侧的小图标
                .setSmallIcon(R.mipmap.ic_notification)
                //设置通知标题
    ...
    public void sendCustomHeadsUpViewNotification(Context context, NotificationManager nm) {
        ...
        //创建通知
        NotificationCompat.Builder nb = new NotificationCompat.Builder(context,NotificationChannels.CRITICAL)
                //设置通知左侧的小图标
                .setSmallIcon(R.mipmap.ic_notification)
                //设置通知标题
