...
import static com.android.wyc.contentproviderclient.DBOpenHelper.DATABASE_STUDENT_TABLE_NAME;
...
public class ClientActivity extends AppCompatActivity {
    ...
    private final StudentContentProvider mStudentContentProvider = new StudentContentProvider();
    ...
    private void updateValue() {
        ...
        getContentResolver().update(STUDENT_URI,contentValues,"name = ?",new String[] {"wyc"});
    }
