...
import static com.android.wyc.notificationdemo.Notificaitons.*;
public class NotificationService extends Service {
    private final static String TAG = "NotificationService";

    public final static String ACTION_SEND_PROGRESS_NOTIFICATION = "com.android.wyc.notificationdemo.ACTION_SEND_PROGRESS_NOTIFICATION";
    ...
    private final List<NotificationContentWrapper> mContent = new ArrayList<>();
