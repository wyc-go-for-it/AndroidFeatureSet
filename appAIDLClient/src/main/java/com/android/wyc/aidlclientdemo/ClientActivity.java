package com.android.wyc.aidlclientdemo;
...
import com.android.wyc.aidlservicedemo.IStudentManager;
import com.android.wyc.aidlservicedemo.bean.Student;
import com.android.wyc.aidlservicedemo.database.StudentTable;

import java.util.List;

public class ClientActivity extends AppCompatActivity {
    private final static String TAG = "wyc.log.ClientActivity";

    private final static String REMOTE_SERVICE_PACKAGE_NAME = "com.android.wyc.aidlservicedemo";
    private final static String REMOTE_SERVICE_CLASS_NAME = "com.android.wyc.aidlservicedemo.StudentManagerService";
    ...
    private final IOnDataChangeListener mOnDataChangeLister = new IOnDataChangeListener.Stub() {
        @Override
    ...
    private void insertStudent() {
        ...
        ContentValues wyc = new ContentValues();
        wyc.put(StudentTable.COLUMN_NAME,"wyc");
        wyc.put(StudentTable.COLUMN_GENDER,0);
        wyc.put(StudentTable.COLUMN_AGE,33);
        wyc.put(StudentTable.COLUMN_SCORE,100);
